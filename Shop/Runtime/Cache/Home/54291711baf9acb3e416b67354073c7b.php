...
<!--search end-->
    ...
    <!--当前位置 start-->
    <div class="block box">
        <div id="ur_here"><?php echo ($ur_here); ?>
            <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            ...
            <div class="box">
                <div class="box_1">
                    <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
                        ...
                        <a href="search.php?keywords=<?php echo ($tag["tag_words"]); ?>" class="f6"><?php echo ($tag["tag_words"]); ?></a>
                        <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo ($tag["tag_words"]); ?>" onclick="if (!confirm('<?php echo ($lang["confirm_drop_tag"]); ?>')) return false;" title="<?php echo ($lang["drop"]); ?>"><img src="images/drop.gif" alt="<?php echo ($lang["drop"]); ?>" /></a>&nbsp;&nbsp;
                        <!-- 标签云结束 {/foreach}-->
                        <!-- {else} -->
